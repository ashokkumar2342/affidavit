...
<style type="text/css">
	@page{margin:0;}
@php
$backgroundImg =storage_path('app/background/f.jpg');
@endphp
	@page first{
...
<body>
	<div class="first"> 
		...
		<div style="padding-top: 18px;margin-left: 150px;font-size: 20px"><b>{{$UserDetail->father_name}}</b></div> 
		<div style="padding-top: -28px;margin-left: 500px;font-size: 20px"><b>{{$UserDetail->village}}</b></div> 
	</div>
	@php
